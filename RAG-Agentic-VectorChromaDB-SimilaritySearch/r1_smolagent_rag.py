...
def rag_with_reasoner(user_query: str) -> str:
    ...
    If there isn't sufficient information, say so.
    Do NOT attempt to search the web or call any functions. Answer only from the context below.
...
Answer:"""
    ...
    # Get response from reasoning model directly (no code execution)
...
def main():
    query = "Compare and contrast the services offered by RankBoost and marketing"
    print(f"\nQuery: {query}\n")
