...
async def main():
    ...
    # Demo questions to run automatically
    demo_questions = [
        "What is the Q4 2024 revenue breakdown by service line?",
        "What was the revenue for NeuralFlow in 2025?",
        "What is the timeline for the ConversePro Launch prep?",
    ]
